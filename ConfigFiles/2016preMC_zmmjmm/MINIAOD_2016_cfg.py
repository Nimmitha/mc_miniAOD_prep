...
# with command line options: step6 --filein file:RECO.root --fileout file:MiniAOD.root --mc --eventcontent MINIAODSIM --runUnscheduled --datatier MINIAODSIM --conditions 106X_mcRun2_asymptotic_preVFP_v11 --step PAT --nThreads 8 --geometry DB:Extended --era Run2_2016_HIPM --python_filename MINIAOD_2016_cfg.py -n -1 --no_exec
