...
# with command line options: step6 --mc --eventcontent AODSIM --datatier AODSIM --conditions 124X_mcRun3_2022_realistic_v12 --step RAW2DIGI,L1Reco,RECO,RECOSIM --procModifiers siPixelQualityRawToDigi --nThreads 8 --geometry DB:Extended --era Run3 --filein file:HLT.root --fileout file:RECO.root --python_filename RECO_2022_cfg.py -n -1 --no_exec
