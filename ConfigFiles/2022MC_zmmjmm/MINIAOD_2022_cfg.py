...
# with command line options: step7 --mc --eventcontent MINIAODSIM --datatier MINIAODSIM --conditions 124X_mcRun3_2022_realistic_v12 --step PAT --nThreads 8 --geometry DB:Extended --era Run3 --filein file:RECO.root --fileout file:MiniAOD.root --python_filename MINIAOD_2022_cfg.py -n -1 --no_exec
